...
// Hardcoded phone for now — API route-data lookup paused (restore with callGridID / rtkID soon)
$phoneNumber = "18887062564";
error_log("📞 FINAL - phoneNumber being used (hardcoded, API paused): " . $phoneNumber);
